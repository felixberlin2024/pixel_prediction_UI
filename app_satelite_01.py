...
import requests
import random
from folium.plugins import ScaleBar  # Import ScaleBar for map legend
...
with col1:
    ...
    m = folium.Map(
        ...
        tiles='https://{s}.tile.openstreetmap.fr/hot/{z}/{x}/{y}.png',  # Satellite-style tiles
        attr='Satellite'
    )
    ...
    ScaleBar(position="bottomright").add_to(m)
